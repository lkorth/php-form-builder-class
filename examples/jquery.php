	...
	<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
		...
		<body>
			...
			<div id="pfbc_content">
				...
				$form->addSlider("Select Rating: (1 = lowest; 5 = highest)", "field7", 3, array("jqueryParams" => array("min" => 1, "max" => 5)));
				$form->addSlider("Select Percentage:", "field8", "", array("suffix" => "%"));
				$form->addSlider("Select Dollar Amount Range: ($5 increments)", "field9", array(25, 75), array("prefix" => "$", "jqueryParams" => array("step" => 5)));
				$form->addSlider("Select Rating Vertical: (1 = lowest; 5 = highest)", "field10", 3, array("height" => 200, "jqueryParams" => array("min" => 1, "max" => 5, "orientation" => "vertical")));
				$form->addSlider("Select Rating: (w/custom scale)", "field11", 3, array("jqueryParams" => array("min" => 1, "max" => 5), "hideDisplay" => 1, "postHTML" => '<table cellpadding="0" cellspacing="0" width="100%" border="0"><tr><td align="left" style="width: 73px;">1</td><td align="left" style="width: 74px;">2</td><td align="left" style="width: 74px;">3</td><td align="left">4</td><td align="right">5</td></tr></table>'));
