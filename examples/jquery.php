	...
	<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
		...
		<body>
			...
			<div id="pfbc_content">
				...
				$form->addDate("Date: (w/multiple months and range limit):", "field3", "", array("jqueryOptions" => array("numberOfMonths" => 2, "minDate" => "-30", "maxDate" => "+30")));
				$form->addDate("Date: (w/custom year range):", "field4", "", array("jqueryOptions" => array("yearRange" => date("Y") - 100 . ":" . date("Y"))));
				$form->addDateRange("Select Date Range:", "field5");
				$form->addDateRange("Date Range: (prefilled w/range limit)", "field6", date("F j, Y", strtotime("-1 month")) . " - " . date("F j, Y"), array("jqueryOptions" => array("minDate" => "-60", "maxDate" => "+60")));
				$form->addSlider("Select Rating: (1 = lowest; 5 = highest)", "field7", 3, array("jqueryOptions" => array("min" => 1, "max" => 5)));
				$form->addSlider("Select Percentage:", "field8", "", array("suffix" => "%"));
				$form->addSlider("Select Dollar Amount Range: ($5 increments)", "field9", array(25, 75), array("prefix" => "$", "jqueryOptions" => array("step" => 5)));
				...
				$form->addRating('Customized Rating: <span id="customRatingCaption"></span>', "field13", 2, range(1, 10), array("jqueryOptions" => array("split" => 2, "cancelShow" => false, "captionEl" => 'js:jQuery("#customRatingCaption")')));
